    ...
    return (
        <>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6" data-aos="fade-up">
                    <div className="pt-24 md:pt-40 pb-16">
                        ...
                        <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
                            ...
                            >
                                {texts.find(text => text.code === "CONTACT_TITLE")?.text}
                            </h1>
                            <div className={"flex gap-2 md:gap-8 justify-center flex-col md:flex-row"}>
                                <Link href={"https://www.instagram.com/amiensfood"}
                                ...
                                <Link href={"mailto:contact@amiensfood.com"}
                                      className={"flex gap-1 bg-white rounded-2xl p-2 items-center max-w-max mx-auto md:max-w-full md:mx-0"}>
                                    <Mail className="w-[30px] text-[#FA8419] "/>
                                    <div className="flex-1 text-left">
                                        <p className={"text-[#FA8419] font-extrabold"}>contact@amiensfood.com</p>
                                    </div>
                                </Link>
                            </div>
                        </div>
            ...
            <div className={"mt-0 md:mt-12 max-w-4xl mx-auto px-12 pb-12"} data-aos="fade-up">
                <h2 className={"h3 mb-8 flex items-center gap-1.5"}>
                    {texts.find(text => text.code === "CONTACT_FORM_TITLE")?.text}
                    <CornerRightDown size={30} className={"mt-3"}/>
                </h2>
                <ContactForm/>
            </div>
        </>
