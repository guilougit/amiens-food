    ...
    const res = await resend.emails.send({
        ...
        html: `
            ...
            <div style="margin: 30px">       
                ...
                <a href="https://amiensfood.com/compte" style="background-color: #FA8419; text-decoration: none; padding: 8px 20px;color:white;border-radius: 10px;font-size:18px;margin: 0 auto;display: block;width: max-content">Je me connecte</a>
                
                
                <p>Tu peux aussi ajouter ta carte sur le wallet de ton téléphone ! </p>
                ...
                <div style="display: flex; justify-content: center;gap: 15px">
                    ...
                    <a href="${androidWalletLink}">
                        <img src="https://amiensfood.com/img/add_to_google_wallet.png" width="100">               
                    </a>
                </div>
                ...
                <p style="margin-top: 50px;">Amiens Food</p>
            </div>  
            `,
