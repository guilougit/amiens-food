                    ...
                    <div className="pt-20 md:pt-40 md:pb-20">
                        ...
                        <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
                            ...
                            <div className="md:w-[600px]">
                                {/* Copy */}
                                <h1 className="text-4xl sm:text-6xl font-bold text-slate-800 mb-6 leading-[1.6] sm:leading-[1.2]"
                                    data-aos="fade-up" data-aos-delay="100">
                                    Mangez bien, <br/>payez moins avec <br/> la carte {' '}
                                    <span className="relative inline-flex items-center justify-center">
                                      <svg className="absolute -z-10" width="246" height="76"
                                ...
                                <p className="text-lg text-slate-700 mb-8" data-aos="fade-up" data-aos-delay="200"
                                   dangerouslySetInnerHTML={{__html: (texts.find(text => text.code === "LANDING_HERO_SUBTITLE")?.text as string)}}>
                                </p>
                            ...
                            <div
                                ...
                                <div className="relative -ml-3 -mr-24 md:mx-0">
                                    <Image
                                        className="absolute -top-36 -left-96 pointer-events-none -z-10 w-[2000px] max-w-none mix-blend-lighten"
                                        src={Illustration}
                                        priority
                                    ...
                                    />
                                    <Tilt>
                                        <Image src={HeroImage} className="md:max-w-none -mt-10 md:mt-0" width="548"
                                               height="545" alt="Carte amiens food" data-aos="fade-up"/>
                                    </Tilt>
                                </div>
                            </div>
                        </div>
