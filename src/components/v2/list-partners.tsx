...
const partners = [
    { title: "Les Offres", offers: ["Mc fleury offert pour toput achat d'un menu best of", 'Offre petit déjeuner à -50%'], image: '/img/mcdo.png'},
    { title: "Les Offres", offers: ['Le menu King Deal à 4€', '-2€ sur le menu Double Whooper'] , image: '/img/bk.png'},
    { title: "Les Offres", offers: ['Offre du Mardi (bucket de tenders à 7.95) disponible tous les jours'], image: '/img/kfc.png'},
    { title: "Les Offres", offers: ['Offre du Mardi (bucket de tenders à 7.95) disponible tous les jours'], image: '/img/kfc.png'},
    { title: "Les Offres", offers: ['Offre du Mardi (bucket de tenders à 7.95) disponible tous les jours'], image: '/img/kfc.png'},
    { title: "Les Offres", offers: ['Offre du Mardi (bucket de tenders à 7.95) disponible tous les jours'], image: '/img/kfc.png'},
];
    ...
    return (
        <section className="mt-6" data-aos-id-4>
            <div className="relative max-w-7xl mx-auto">
                ...
                <div className="mx-8 px-4 sm:px-6 mt-10" data-aos="fade-up" data-aos-anchor="[data-aos-id-4]">
                    <div className="py-12 md:pb-20">
                        ...
                        <div className="w-full shrink-0">
                                ...
                                {/* Button */}
                                <div className="max-w-xs mx-auto sm:max-w-none mt-8" data-aos="fade-up">
                                    <div>
                                        <a className="btn-sm inline-flex items-center text-white bg-primary group shadow-sm" href="apply.html">
                                            ...
                                            <span className="tracking-normal text-sky-300 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-2">
                                                <svg className="fill-white" width="12" height="10" xmlns="http://www.w3.org/2000/svg">
